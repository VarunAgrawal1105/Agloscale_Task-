...
if($email != NULL and $Password != NULL and $Username != NULL and $first_name != NULL and $last_name != NULL  ){
$q = "INSERT INTO `admin_login`(`id`, `admin_email`, `admin_pass`, `admin_username`, `first_name`, `last_name`) VALUES (NULL,'$email','$Password','$Username','$first_name','$last_name')";
